...
function zoomST(c) {
	if($i5a6('zoomimglayer').style.display == '') {
		...
		if(c <= 5) {
			...
			$i5a6('zoomimglayer').innerHTML = '<table cellspacing="0" cellpadding="2"><tr><td style="text-align: right;FONT-FAMILY: Verdana,Helvetica,Arial,sans-serif;font-size=12px">'+zoomwheel+'&nbsp;&nbsp;&nbsp;&nbsp;  <a href="' + zoomobj['zimg'] + '" target="_blank"><img src="' + IMGDIR + '/newwindow.gif" border="0" style="vertical-align: middle" title="'+newWindowPic+'" /></a> <a href="###" onclick="zoomimgadjust(event, 1)"><img src="' + IMGDIR + '/resize.gif" border="0" style="vertical-align: middle" title="'+resizePic+'" /></a> <a href="###" onclick="zoomclose()"><img style="vertical-align: middle" src="' + IMGDIR +'/close.gif" title="'+closePic+'"  border="0"/></a>&nbsp;</td></tr><tr><td align="center" id="zoomimgbox"><img id="zoomimg" style="cursor: move; margin: 5px;" src="' + zoomobj['zimg'] + '" width="' + $i5a6('zoomimglayer').style.width + '" height="' + $i5a6('zoomimglayer').style.height + '"></td></tr></table>';
